...
const config: ForgeConfig = {
  packagerConfig: {
    asar: true,
    name: 'Chat LAN',
    executableName: 'chat-lan',
    appBundleId: 'dev.claudiosoares.chatlan',
    // macOS 15+ pede permissão de "Rede Local" para mDNS e conexões na LAN.
    extendInfo: {
  ...
  rebuildConfig: {},
  makers: [
    new MakerSquirrel({ name: 'chat_lan', setupExe: 'ChatLAN-Setup.exe' }),
